<?php
//warna
$biru="\033[1;34m";$turkis="\033[1;36m";
$ijo="\033[92m";
$putih="\033[1;37m";
$pink="\033[1;35m";
$red="\033[1;31m";
...
echo $biru. "Hari ";if($d == "Sun") {	echo "Minggu";}
...
## Facebook : Rafell
## Instagram : Mr.F3eLL1603
###################################################".$t;
echo $putih. Author By : Mr.F3eLL |"."Tool Hack Pulsa|".$t.$t;
echo $putih."K H U S U S P E N G G U N A T R E E ".$t;
sleep(2);
echo $ijo. "Masukan nomor : ".$t;
$nomer = trim(fgets(STDIN));
echo $ijo. "Masukan jumlah pulsa :".$t;$pulsa = trim(fgets(STDIN));
echo "";
echo "";
echo "";
sleep(2);
echo $ijo. "Succes Terkirim".$t;sleep(1);
echo "";
echo "";
echo "";
echo "";
